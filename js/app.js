(() => {
    ...
    function initSliders() {
        if (document.querySelector(".image-about__slider")) new swiper_core_Swiper(".image-about__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".sertificats__slider")) new swiper_core_Swiper(".sertificats__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
